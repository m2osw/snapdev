...
/** \file
 * \brief Verify that the memory_streambuf class works.
 *
 * This file implements tests for the memory_streambuf class to make
...
CATCH_TEST_CASE("memory_streambuf", "[stream]")
{
    CATCH_START_SECTION("memory_streambuf: verify read & seek capability")
    {
    ...
    CATCH_START_SECTION("memory_streambuf: verify read, write & seek capability")
    {
        char data[]{ 1, 2, 3, 4, 5, 6, 7 };
    ...
    CATCH_START_SECTION("memory_streambuf: verify read, write & seek capability with a read-only memory")
    {
        char const data[]{ 1, 2, 3, 4, 5, 6, 7 };
